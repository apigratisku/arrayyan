...
$message = "
Dear Admin,<br>
Mohon bantuannya untuk dapat diteruskan ke tim Technical Support sesuai data berikut:<br><br>
...
<br><br>Demikian informasi yang disampaikan.<br>
Terima Kasih.
";
        ...
        $headers .= "From: Blippy Support Assistant <".$from.">" . "\r\n";
        $headers .= "Cc: ".$cc1.",".$cc2.",".$cc3."" . "\r\n";
