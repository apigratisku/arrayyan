...
class Noc_tiket_noc_hd extends CI_Controller {
    ...
    public function index() {
        if (!file_exists(APPPATH.'views/backend/noc_tiket_noc_hd/index.php')) {
            show_404();
        }
        ...
        $data['menu']  = 'noc_tiket_noc_hd';
        $data['title'] = 'Data PIC HD';
        $data['items'] = $this->m_noc_tiket_noc_hd->get();
       
		$this->load->view('backend/header', $data);
		$this->load->view('backend/noc_tiket_noc_hd/index', $data); 
        $this->load->view('backend/footer');
    }

    public function tambah() {
        if (!file_exists(APPPATH.'views/backend/noc_tiket_noc_hd/input.php')) {
            show_404();
        }
		$data['wo_all'] = $this->m_wo->count_wo_all();
		$data['wo_selesai'] = $this->m_wo->count_wo_selesai();
        ...
        ";
		$this->load->view('backend/header', $data);
        $this->load->view('backend/noc_tiket_noc_hd/input', $data);
    ...
    public function simpan() {
		...
		$this->m_noc_tiket_noc_hd->simpan();
		$data['wo_all'] = $this->m_wo->count_wo_all();
		$data['wo_selesai'] = $this->m_wo->count_wo_selesai();
		$data['wo_baru'] = $this->m_wo->count_wo_baru();		
		$data['jumlah_pelanggan'] = $this->m_data_pelanggan->count();
    ...
    public function ubah($id) {
        ...
        $data['item']  = $this->m_noc_tiket_noc_hd->get($id);
    ...
    public function timpa($id) {
        ...
        $this->m_noc_tiket_noc_hd->timpa($id);
		redirect('manage/noc_tiket_noc_hd');
    }
	
	
    public function hapus($id) {
        if ($this->m_noc_tiket_noc_hd->delete($id)) {
