...
return false;">
						...
						<option value="<?php echo base_url('manage/scheduler/tambah_h'); ?>" selected="selected">Dismantle (Close Port)</option>
						</select>
						<input type="hidden" name="permintaan" value="Dismantle" />
             </div>
			 <div class="form-group">
