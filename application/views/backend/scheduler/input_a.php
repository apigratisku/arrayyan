...
return false;">
						<option value="<?php echo base_url('manage/scheduler/tambah_a'); ?>" selected="selected">Upgrade</option>
						...
						<input type="hidden" name="permintaan" value="Upgrade" />
             </div>
			 <div class="form-group">
			 ...
			 <div class="form-group">
				...
				<div class="input-group">
                  ...
                  <input type="text"  class="form-control datetimepicker-alt" id="datetime2" name="mulai" width="50%" required autofocus>
			...
			<div class="col-md-6">
			 ...
			 <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Contoh:5M/5M" id="bw" name="bw" value="<?php echo isset($item) ? $item['bw'] : ''; ?>" autofocus required>
            </div>
			<div class="form-group">
