...
return false;">
						...
						<option value="<?php echo base_url('manage/scheduler/tambah_f'); ?>" selected="selected">Free BOD +100%</option>
						...
						<input type="hidden" name="permintaan" value="Free BOD +100% Bandwidth" />
