...
return false;">
						...
						<option value="<?php echo base_url('manage/scheduler/tambah_d'); ?>">Buka Isolir</option>
						...
						<option value="<?php echo base_url('manage/scheduler/tambah_g'); ?>" selected="selected">BOD Berbayar (Non Pelanggan)</option>
						<option value="<?php echo base_url('manage/scheduler/tambah_h'); ?>">Dismantle (Close Port)</option>
						</select>
						<input type="hidden" name="permintaan" value="BOD Berbayar" />
...
$("#datetime2").datetimepicker({
	...
	autoclose: true
             ...
             <div class="form-group">
                <label for="nama_keahlian">Selesai</label>
				<div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-clock-o"></i>
                  </div>
                <input type="text" class="form-control datetimepicker-alt" id="datetime3" name="selesai" required autofocus>
<script type="text/javascript">
	...
	autoclose: true
			...
			<div class="col-md-6">
			 ...
			 <div class="form-group">
                ...
                <input placeholder="Contoh: 10M/10M" type="text" class="form-control" id="bw" name="bw" value="<?php echo isset($item) ? $item['bw'] : ''; ?>" required autofocus>
            </div>
