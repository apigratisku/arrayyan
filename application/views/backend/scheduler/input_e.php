...
return false;">
						...
						<option value="<?php echo base_url('manage/scheduler/tambah_e'); ?>" selected="selected">Free BOD +50%</option>
						...
						<input type="hidden" name="permintaan" value="Free BOD +50% Bandwidth" />
