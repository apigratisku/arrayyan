...
<html lang="en">
    ...
    <head>
        ...
        <title>BLiP Bypass Hotspot Tool</title>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-4 col-md-4 col-md-offset-4 login-form">
                    ...
                    <center>
                       <img src="<?php echo base_url('static/assets/img/logo.png'); ?>" width="200" alt="Get Biger Image">
                    </center>
                    ...
                    <?php echo form_open('bypass/simpan'); ?>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="ip" name="ip" placeholder="IP Address" required autofocus>
                            </div>
                        </div>

                        <div class="spacer-1"></div>

                        <button type="submit" class="btn btn-primary btn-block btn-lg">BYPASS</button>
