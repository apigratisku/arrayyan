...
<div style="background-color:#222d32; font-weight:bold; color:#ff4e00; font-size:20px; padding:10px 0px 10px 10px">
    ...
    <div class="panel-body">
        ...
        <?php
        if (isset($item)) {
            echo form_open('manage/kpi_induk/' . $item['id'] . '/timpa');
        } else {
            echo form_open('manage/kpi_induk/simpan');
        }
        ?>
			<div class="col-md-6">
			...
			<div class="row">
                <div class="col-md-12 form-buttons" align="left">
                    ...
                    &nbsp;
                    <a href="<?php echo base_url('manage/kpi_induk'); ?>" class="btn btn-warning"><i class="fa fa-arrow-circle-left"></i>&nbsp; Kembali</a>
                </div>
            </div>
