...
<html lang="en">
    ...
    <head>
        ...
        <title>Internet Service Provider - Fiberstream by Gmedia</title>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-4 col-md-4 col-md-offset-4 login-form">
					 <center>
                       <img src="<?php echo base_url('static/assets/img/fs.png'); ?>" width="300" alt="Get Biger Image">
                    </center>
                    ...
                    <?php echo form_open('auth/login_fiberstream'); ?>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="cid" name="cid" placeholder="Masukan CID anda" required autofocus>
                            </div>
                        </div>
