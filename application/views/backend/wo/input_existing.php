...
<br>
    <div class="panel-body">
        ...
        ?>
			...
			<!-- PANEL HEADLINE 1 -->
			<div class="col-md-6">
			<input type="hidden" name="check_pel" value="">
...
<?php if(isset($item['area'])):?><option value="<?php echo isset($item) ? $item['area'] : ''; ?>" selected><?php echo isset($item) ? $item['area'] : ''; ?></option><?php endif; ?>
			...
			<div class="form-group">
				...
				<?php $req_id = $this->db->get_where('blip_kpi', array('id' => $item['request']))->row_array(); ?>
			...
			<?php
			$id_layanan1 = $this->db->order_by("id", "asc")->limit(1)->get_where('blip_layanan', array('id_pelanggan' => $item_pelanggan['id']))->row_array();
			$id_layanan2 = $this->db->order_by("id", "desc")->limit(1)->get_where('blip_layanan', array('id_pelanggan' => $item_pelanggan['id']))->row_array();
			?>
			<div class="form-group">
				<label for="level">Produk 1</label>
				<select class="form-control" id="produk1" name="produk1">
				<option value="">- Produk 2-</option>
				<?php $produk_id = $this->db->get_where('blip_produk', array('id' => $id_layanan1['id_produk']))->row_array(); ?>
			...
			<div class="form-group">
				...
				<option value="">- Produk 2-</option>
				<?php $produk_id = $this->db->get_where('blip_produk', array('id' => $id_layanan2['id_produk']))->row_array(); ?>
				<?php if(isset($produk_id['produk'])):?><option value="<?php echo isset($produk_id['id']) ? $produk_id['id'] : ''; ?>" selected><?php echo isset($produk_id['produk']) ? $produk_id['produk'] : ''; ?></option><?php endif; ?>
				<?php foreach ($items_admin_produk as $produk): ?>
				<option value="<?php echo $produk['id']; ?>"><?php echo $produk['produk']; ?></option>
				<?php endforeach; ?>
			...
			<div class="form-group">
                ...
                <input type="number" class="form-control" id="bandwidth1" name="bandwidth1" value="<?php echo isset($id_layanan1['id_bandwidth']) ? $id_layanan1['id_bandwidth'] : ''; ?>"  autofocus>
            </div>
			<div class="form-group">
                <label for="nama_keahlian">Bandwidth Produk 2</label>
                <input type="number" class="form-control" id="bandwidth2" name="bandwidth2" value="<?php echo isset($id_layanan2['id_bandwidth']) ? $id_layanan2['id_bandwidth'] : ''; ?>"  autofocus>
            </div>
			<div class="form-group">
