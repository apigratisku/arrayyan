        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-4 col-md-4 col-md-offset-4 login-form">
                    ...
                    <center>
                       <img src="<?php echo base_url('static/assets/img/logo.png'); ?>" width="300" alt="Get Biger Image">
                    </center>
                    ...
                    <?php echo form_open('auth/token'); ?>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="token" name="token" placeholder="2FA TOKEN" required autofocus>
                            </div>
                        </div>
                    </form>
