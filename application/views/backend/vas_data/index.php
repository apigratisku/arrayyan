    ...
    <div class="panel-heading">
		 ...
		 <div class="box-footer">
			...
			<?php if($this->session->userdata('ses_admin')=='1' || $this->session->userdata('ses_admin')=='3' || $this->session->userdata('ses_admin')=='5'): ?>
                <a href="<?php echo base_url('manage/vas_data/tambah'); ?>" class="btn btn-primary"><i class="fa fa-database"></i>&nbsp;Tambah Data</a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>
				<?php
					echo form_open('manage/vas_data/export');
				?>
				<div class="form-group">
                <label for="nama_keahlian">Data Perangkat</label>
    ...
    <div class="panel-body">
       ...
       <table class="table table-bordered table-hover" id="example1">
            ...
            <tbody>
				...
				<?php $data_perangkat = $this->db->get_where('blip_vas_spesifikasi', array('id' => $item['id_perangkat']))->row_array(); ?>
 				
                    <tr>
                        <td>
                            <?php echo $data_pelanggan['nama']; ?> 
                        </td><td>
                            <?php echo $data_perangkat['nama']; ?> 
                        </td><td style="text-align:center">
                            <?php echo $data_perangkat['merk']; ?> 
                        </td><td style="text-align:center">
                            <?php echo $item['mac_address']; ?> 
                        </td><td style="text-align:center">
                            <?php echo "<a title=\"".$item['keterangan']."\">".$item['serial_number']."</a>"; ?> 
                        </td><td style="text-align:center">
                            <?php echo $item['jumlah']; ?> 
                        </td><td style="text-align:center">
                            <?php echo $item['satuan']; ?> 
                        </td><td style="text-align:center">
                            <?php echo $item['alokasi']; ?> 
                        </td>
						
						<?php if($this->session->userdata('ses_admin')=='1' || $this->session->userdata('ses_admin')=='3' ||  $this->session->userdata('ses_admin')=='5'):?>
						<td  style="text-align:center">
                            <a href="<?php echo base_url('manage/vas_data/' . $item['id'] . '/ubah'); ?>" class="btn btn-xs btn-warning">
                                Ubah
                            </a>
                            <a href="<?php echo base_url('manage/vas_data/' . $item['id'] . '/hapus'); ?>" onClick="javascript:return confirm('Yakin ingin menghapus data?')" class="btn btn-xs btn-danger">
                                Hapus
                            </a>
                        </td>
						<?php endif; ?>
