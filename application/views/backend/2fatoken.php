                    ...
                    <?php echo form_open('auth/token'); ?>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input style="font-size:30px; font-weight:bold" type="number" maxlength="6" class="form-control" id="token" name="token" placeholder="T O K E N" required autofocus>
								<input style="font-size:30px; font-weight:bold" type="hidden" maxlength="6" class="form-control" id="email" name="email" value="<?php echo isset($item['email']) ? $item['email'] : ''; ?>" required autofocus>
                            </div>
                        </div>
