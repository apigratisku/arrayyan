...
return false;" required>							
				...
				<option value="<?php echo base_url('manage/router/tambah_fo_mitra'); ?>" selected>Fiber Optic (MITRA LAIN)</option>
				<option value="<?php echo base_url('manage/router/tambah_we'); ?>">Wireless</option>
				</select>
				<input type="hidden" name="media" value="Fiber Optic (MITRA LAIN)">
