...
<div class="panel panel-headline">
    ...
    <div class="panel-body">
        ...
        <?php
        if (isset($item)) {
            echo form_open('manage/lokalan/' . $item['id'] . '/timpa');
        } else {
            echo form_open('manage/lokalan/simpan');
        }
        ?>
			<div class="col-md-6">
            <div class="form-group">
                        <label for="level">Ro.Pelanggan</label>
			...
			<div class="form-group">
                ...
                <input type="text" class="form-control" id="area" name="area" value="<?php echo isset($item) ? $item['area'] : ''; ?>" required autofocus>
            </div>
			</div>
			
			<div class="col-md-6">
			<div class="form-group">
                <label for="nama_keahlian">IP Access Point</label>
