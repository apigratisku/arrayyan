...
<div style="background-color:#222d32; font-weight:bold; color:#ff4e00; font-size:20px; padding:10px 0px 10px 10px">BTS - RADIO ACCESS POINT</div>
    ...
    <div class="panel-body">
        ...
        <?php
        if (isset($item)) {
            echo form_open('manage/station/' . $item['id'] . '/timpa');
        } else {
            echo form_open('manage/station/simpan');
        }
        ?>
			...
			<div class="form-group">
                <label for="nama_keahlian">Port API</label>
			 ...
			 <div class="row">
				...
				<button type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i>&nbsp; Simpan</button>&nbsp;
                    <a href="<?php echo base_url('manage/station'); ?>" class="btn btn-warning"><i class="fa fa-arrow-circle-left"></i>&nbsp; Kembali</a>
