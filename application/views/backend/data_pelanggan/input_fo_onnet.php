...
return false;" required>							
				<option value="<?php echo base_url('manage/router/tambah_fo_onnet'); ?>" selected>Fiber Optic (Onnet)</option>
				...
				<input type="hidden" name="media" value="Fiber Optic (Onnet)">
...
<?php if(isset($get_item['area'])):?><option value="<?php echo isset($get_item) ? $get_item['area'] : ''; ?>" selected><?php echo isset($get_item) ? $get_item['area'] : ''; ?></option><?php endif; ?>
			...
			<div class="form-group">
                <label for="dr">ODP</label>
                <select class="form-control" id="odp" name="odp" required>	
				<?php foreach ($odp_items as $odp_item): ?>							
				<option value="<?php echo $odp_item['id']; ?>"><?php echo $odp_item['odp']; ?></option>
				<?php endforeach; ?>
				</select>
            </div>
			<div class="form-group">
                <label for="nama_keahlian">PON</label>
                <input placeholder="Raisecom: 1/1/1 dan ZTE: 2/1/1:1" type="text" class="form-control" id="pon" name="pon" value="<?php echo isset($get_item) ? $get_item['pon'] : ''; ?>" required autofocus>
            </div>
			<div class="form-group">
